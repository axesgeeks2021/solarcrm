        ...
        <div className="documents w-full flex justify-evenly items-center flex-col gap-10">
          ...
          <div className="documents__card flex justify-evenly items-center">
            <div className="document__card__details p-2">
              ...
              <div
s                className={`${allStatus?.meter?.map(ele => ele?.meter_status === "Completed" ? "status" : "pending")}`}
            >
            ...
            <div className="status__uploading">
              ...
              <div className="uploading">
                <div className="container">
                  ...
                  >
                  <UploadFile id="meter_box" onchange={fileUpload} name="meter_box" />
          ...
          <div className="status__uploading">
            ...
            <div className="uploading">
              <div className="container">
                ...
                >
                <UploadFile id="electricity_bill" onchange={fileUpload} name="electricity_bill" />
                  <input
          ...
          >
            ...
            <p style={{margin: 0}}>4 files left</p>
          </div>
          <div className="documents__connected__line"></div>
          <div className="status__uploading">
            ...
            <div className="uploading">
              <div className="container">
                ...
                >
                <UploadFile id="miscellaneous_file" onchange={fileUpload} name="miscellaneous_file" />
                  <input
