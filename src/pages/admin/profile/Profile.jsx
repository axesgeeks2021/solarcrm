...
function AdminProfile() {
  ...
  console.log('adminprof', adminProfile)
      ...
      <div style={{ width: "100%", display: 'flex', justifyContent: 'center', alignItems: 'flex-start' }}>
        ...
        <div style={{ width: "80%", display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '2rem 0', flexDirection: 'column' }}>
          ...
          <div className='content'>
            <div>
              <p>Username: {adminProfile?.user?.username}</p>
              <p>Name: {adminProfile?.user?.first_name} {adminProfile?.user?.last_name}</p>
            </div>
            <div>
            ...
            <div>
              <p>Address: {adminProfile?.address_line}</p>
              <p>City: {adminProfile?.city}</p>
            </div>
            <div>
              <p>State: {adminProfile?.state}</p>
              <p>Country: {adminProfile?.country}</p>
            </div>
          </div>
        </div>
          {
