  ...
  return (
    <div style={{ width: "100%", display: 'flex', justifyContent: 'center' }} >
      ...
      <div className="container__table completeContainer" style={{ justifyContent: 'flex-start' }}>
        ...
        {
          (orderDetails?.order?.packing_slip.length < 1 && orderDetails?.order?.panel_layout.length < 1 && orderDetails?.order?.switch_board.length < 1 && orderDetails?.order?.western_power.length < 1) ?
          null : 
          <div className="completejobs__box">
            <div className="header">
