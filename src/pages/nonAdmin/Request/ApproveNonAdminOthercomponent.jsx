...
function ApproveNonAdminOthercomponent() {
    ...
    const fetchOrderDetails = () => {
        try {
            ...
            fetch(`https://solar365.co.in/non-admin-order/${location?.state?.ele?.id}/`, requestOptions)
        ...
        <div className='container-fluid' style={{ display: 'flex', flexDirection: 'row' }}>
            ...
            <div className="container py-5">
                ...
                <ul className="responsive-table">
                    ...
                    {
                        orderDetail?.other_component?.map((ele, idx) => {
                            return (
...
export default ApproveNonAdminOthercomponent
