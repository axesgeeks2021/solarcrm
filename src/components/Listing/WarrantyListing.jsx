  ...
  return (
    <ol className="gradient-list flex flex-wrap justify-around items-start relative overflow-hidden warranty">
      <li>
        ...
        <a
          href={`http://13.126.231.119/${document.data?.install_docs?.battery_docs}`}
          download
        >
          Download
        </a>
      ...
      <li>
        ...
        <a
          href={`http://13.126.231.119/${document.data?.warranty?.inverter_docs}`}
          download
        >
          Download
        </a>
      ...
      <li>
        ...
        <a
          href={`http://13.126.231.119/${document.data?.warranty?.panels_docs}`}
          download
        >
          Download
        </a>
